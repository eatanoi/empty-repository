/* service worker ของเกม "โรงเชื่อมอิเล็กตรอน" (พันธะโคเวเลนต์)
...
self.addEventListener('activate', e=>{
  e.waitUntil((async ()=>{
    ...
    await Promise.all(keys.filter(k=>k.startsWith('covalent-') && k!==CACHE).map(k=>caches.delete(k)));
