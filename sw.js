...
self.addEventListener('fetch', e=>{
  ...
  if(['cell/','transport/','respiration/','division/','reproduction/','covalent/','ionic/','metallic/','privacy/'].some(d=>url.pathname.startsWith(BASE+d))) return;
